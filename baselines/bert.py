...
Original file is located at
    https://colab.research.google.com/drive/1WRhLlL74IA6zKb7nxqwTgYMxG2B2V9WR
...
class ImprovedModel(nn.Module):
    ...
    def __init__(self, model_name='sentence-transformers/all-MiniLM-L6-v2', n_homonyms=300, dropout=0.2):
        super().__init__()
