...
class ImprovedModel(nn.Module):
    ...
    def __init__(self, model_name='bert-base-uncased', n_homonyms=300, dropout=0.2):
        super().__init__()
...
def train_model(model_name='bert-base-uncased', epochs=10, batch_size=16, lr=2e-5):
    print("\n" + "="*80)
...
for homonym in CHALLENGING_HOMONYMS[:10]:
    ...
    if len(data) > 0:
        ...
        status = '' if avg_error < 1.0 else '' if avg_error < 1.5 else ''
